...
namespace Com\Youzan\Test\Servicespecification;
...
class GenericService extends TSpecification {
  ...
  protected $serviceName = 'Com.Youzan.Test.Service.GenericService';
  ...
  protected $inputStructSpec = [
    'invoke' => [
      1 => [
        'var' => 'request',
        'type' => TType::STRUCT,
        'class' => '\Com\Youzan\Test\Service\GenericRequest',
        ],
    ],
  ];
  protected $outputStructSpec = [
    ...
    'invoke' => [
      'type' => TType::STRUCT,
      'class' => '\Com\Youzan\Test\Service\GenericResponse',
    ],
  ];
  protected $exceptionStructSpec = [
    ...
    'invoke' => [
      1 => [
        'var' => 'ex',
        'type' => TType::STRUCT,
        'class' => '\Com\Youzan\Test\Service\GenericException',
        ],
    ],
  ];
}
